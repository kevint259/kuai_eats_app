...
const String emailLogin = "Email";
const String emailRegister = "Email (Gmail, Yahoo, etc.)";
const String passwordLogin = "Password";
const String passwordRegister = "Password (6~20 characters)";
